...
Array.prototype.forEach.call(document.querySelectorAll('#productIntroTableOfContents .tab-name'), function(button, index) {
	...
	button.addEventListener('click', function(e) {
		e.preventDefault();
		gsap.to(window, {duration: 0.4, scrollTo: {y: target, offsetY: 48}});
	});
});

const links = document.querySelectorAll('#productIntroTableOfContents .tab-item');
const sections = document.querySelectorAll('.product-intro .section');
