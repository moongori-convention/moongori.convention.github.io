...
// 스크랩
var favoriteStore = function(elem) {
	var title = elem.querySelector('title');
	var path = elem.querySelector('path');
	if(elem.classList.contains('checked')) {
		elem.classList.remove('checked');
...
var directToggle = new buiToggle('[data-bui-toggle="direct-toggle"]');
...
var contentBreadcrumbs = function(selector) {
