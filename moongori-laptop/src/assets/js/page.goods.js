...
if (document.querySelector('#productIntroTableOfContents')) {
	ScrollTrigger.create({
		...
		// markers: true,
		onEnter: function(self) {document.querySelector('#page').classList.add('inactive-head');},
		onLeaveBack: function(self) {document.querySelector('#page').classList.remove('inactive-head');},
	});
}
...
if (document.querySelector('#productIntro')) {
	ScrollTrigger.create({
		...
		toggleClass: 'active',
		onEnter: function(self) {document.querySelector('#productOrderArea').classList.add('active');},
		onLeaveBack: function(self) {document.querySelector('#productOrderArea').classList.remove('active');},
		onLeave: function(self) {document.querySelector('#productOrderArea').classList.add('on-leave');},
		onEnterBack: function(self) {document.querySelector('#productOrderArea').classList.remove('on-leave');},
		// markers: true
	});
